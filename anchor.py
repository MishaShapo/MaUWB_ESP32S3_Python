...
sendDataAndReadResponse("AT+RESTORE", 5);

sendDataAndReadResponse(config_cmd());
sendDataAndReadResponse(cap_cmd());

sendDataAndReadResponse("AT+SETRPT=1");
sendDataAndReadResponse("AT+SAVE");
sendDataAndReadResponse("AT+RESTART");
